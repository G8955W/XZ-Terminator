    ...
    resources: {
      zh: {
        translation: {
          ...
          'pain-transfer-topic-label': '你在纠结什么？',
          'pain-transfer-topic-placeholder': '例如：今晚谁买单？',
          'pain-transfer-topic-title': '你的朋友正在纠结：',

          // 文字冒险
          'text-rpg-title': '文字冒险',
          'home-text-rpg': '文字冒险',
          'home-text-rpg-desc': '剧情风格随机决策',
          'text-rpg-input-title': '命运的十字路口',
          'text-rpg-input-desc': '输入你纠结的选项，让命运来裁决',
          'text-rpg-option': '选项',
          'text-rpg-add-option': '添加更多选项',
          'text-rpg-enter-story': '🎭 进入剧情',
          'text-rpg-hint': '选择终结者将随机抽取一个天命之选',
          'text-rpg-win': '天命之选',
          'text-rpg-try-again': '再来一次',
          'text-rpg-back-menu': '返回主页',

          // 盲盒命运
          'mystery-box-title': '纯平手绘盲盒',
          'home-mystery-box': '纯平手绘盲盒',
          'home-mystery-box-desc': '手绘风格随机盲盒',
          'mystery-box-input-title': '命运的选项',
          'mystery-box-input-desc': '写下你的纠结选项，交给命运决定',
          'mystery-box-option': '选项',
          'mystery-box-add-option': '添加更多选项',
          'mystery-box-generate': '🎁 生成盲盒',
          'mystery-box-hint': '点击盲盒揭晓你的命运！',
          'mystery-box-pick-title': '选择一个盲盒！',
          'mystery-box-pick-desc': '每个盲盒都藏着一个可能性',
          'mystery-box-your-fate': '✨ 你的命运是 ✨',
          'mystery-box-try-again': '再抽一次',
          'mystery-box-back-menu': '返回主页',
      ...
      en: {
        translation: {
          ...
          'pain-transfer-topic-label': 'What are you struggling with?',
          'pain-transfer-topic-placeholder': 'e.g. Who pays tonight?',
          'pain-transfer-topic-title': 'Your friend is struggling with:',          
          // Text RPG
          'text-rpg-title': 'Text Adventure',
          'home-text-rpg': 'Text Adventure',
          'home-text-rpg-desc': 'Story-style random decision',
          'text-rpg-input-title': 'Crossroads of Fate',
          'text-rpg-input-desc': 'Enter your options and let fate decide',
          'text-rpg-option': 'Option',
          'text-rpg-add-option': 'Add more options',
          'text-rpg-enter-story': '🎭 Enter Story',
          'text-rpg-hint': 'The Decision Terminator will randomly select a Heaven\'s Choice',
          'text-rpg-win': 'Heaven\'s Choice',
          'text-rpg-try-again': 'Try Again',
          'text-rpg-back-menu': 'Back to Menu',

          // Mystery Box
          'mystery-box-title': 'Hand-drawn Mystery Box',
          'home-mystery-box': 'Hand-drawn Mystery Box',
          'home-mystery-box-desc': 'Hand-drawn style random box',
          'mystery-box-input-title': 'Options of Fate',
          'mystery-box-input-desc': 'Write down your options and let fate decide',
          'mystery-box-option': 'Option',
          'mystery-box-add-option': 'Add more options',
          'mystery-box-generate': '🎁 Generate Mystery Boxes',
          'mystery-box-hint': 'Click a box to reveal your fate!',
          'mystery-box-pick-title': 'Pick a Box!',
          'mystery-box-pick-desc': 'Each box holds a possibility',
          'mystery-box-your-fate': '✨ Your Fate Is ✨',
          'mystery-box-try-again': 'Try Again',
          'mystery-box-back-menu': 'Back to Menu',
